...
<td valign="top" class="[{$listclass}]" height="15"><div class="listitemfloating"><a href="Javascript:top.oxid.admin.editThis('[{$listitem->oxarticles__oxid->value}]');" class="[{$listclass}]">[{$oView->fcGetProfitMargin($listitem->oxarticles__oxbprice->value, $listitem->oxarticles__oxprice->value, 19)}]</a></div></td>
